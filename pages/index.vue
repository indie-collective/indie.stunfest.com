    ...
    <div>
      ...
      >
        ...
        <div class="columns is-tablet is-multiline is-centered">
          <card
            v-for="i in randomizeCards(items.competition)"
            :key="i.title"
            :card="i"
      ...
      <section v-if="filter === 'all' || filter === 'village'" class="section">
        ...
        <div class="columns is-tablet is-multiline is-centered">
          <card
            v-for="i in randomizeCards(items.village)"
            :key="i.title"
            :card="i"
          >
            {{ i.summary }}
      ...
      >
        ...
        <div class="columns is-tablet is-multiline is-centered">
          <card
            v-for="i in randomizeCards(items.prototypes)"
            :key="i.title"
            :card="i"
          >
            {{ i.summary }}
